...
const useWpmCalculationHandler = ({setIsShowTypingOverModal , setWpmFinal , isTypingEnds,startTypingTimeRef,amountOfTimeRef ,wordHistory , wrongChars ,  currentText , totalCorrectedCharsRef }:wpmCalculattionHandlerProps)  => {
