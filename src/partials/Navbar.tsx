        ...
        <div className="mx-auto max-w-7xl">
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="hidden sm:flex items-center space-x-1">
              <NavLink href="/learn" highlight={location.pathname === "/learn"}>
                Learn
              </NavLink>
              <NavLink href="/" highlight={location.pathname === "/"}>
                Practice
              </NavLink>
              <NavLink href="/test" highlight={false}>
                Test
              </NavLink>
              <NavLink href="/games" highlight={false}>
                Games
              </NavLink>
              <NavLink href="/custom" highlight={false}>
                Custom Practice
              </NavLink>
            </div>
